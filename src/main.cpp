...
uint256 hashGenesisBlock("0xf273314d20f9db2062bb235700657349d3a5f4d6218c6079ffb3bbd84b7f5846");
...
static const int64 nTargetSpacing = 90; // FooCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal sen miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf273314d20f9db2062bb235700657349d3a5f4d6218c6079ffb3bbd84b7f5846");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "MYSEN Born";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1501688216; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 638623;

        if (fTestNet)
        {
            block.nTime    = 1501688216;
            block.nNonce   = 638623;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xddfd39df04346e634fa28bb48907dc6d742b3905a3c321062b5319ba12fe8c93"));
