...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "sen.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    {
        // Don't overwrite existing settings so command line settings override sen.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "sen.pid"));
