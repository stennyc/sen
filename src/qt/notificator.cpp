...
extern bool qt_mac_execute_orange_script(const QString &script, AEDesc *ret);
#endif
...
void Notificator::notifyGrowl(Class cls, const QString &title, const QString &text, const QIcon &icon)
{
    ...
    qt_mac_execute_orange_script(script.arg(notificationApp, quotedTitle, quotedText, notificationIcon, growlApp), 0);
}
#endif
