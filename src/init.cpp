    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("FooCoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  sen [options]                     " + "\n" +
                  "  sen [options] <command> [params]  " + _("Send command to -server or sen") + "\n" +
                  "  sen [options] help                " + _("List commands") + "\n" +
                  "  sen [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "sen:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: sen.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: sen.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 11889 or testnet: 21889)") + "\n" +
...
//    }
    ...
    // Make sure only a single sen process is using the data directory.
    ...
    // requested to kill sen-qt during the last operation. If so, exit.
